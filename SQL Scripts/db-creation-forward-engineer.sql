...
-- -----------------------------------------------------
-- Table `petadoptiondb`.`manager`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `petadoptiondb`.`manager` (
  `employeeid` BIGINT NOT NULL,
  `shelterid` BIGINT NOT NULL,
  PRIMARY KEY (`employeeid`, `shelterid`),
  INDEX `FK3ws3jjgd8fte4ejvhenbty1ib` (`shelterid` ASC) VISIBLE,
  CONSTRAINT `FK3ws3jjgd8fte4ejvhenbty1ib`
    FOREIGN KEY (`shelterid`)
    REFERENCES `petadoptiondb`.`shelter` (`id`),
  CONSTRAINT `FKfu0e040buc1hb5b7etacaq33n`
    FOREIGN KEY (`employeeid`)
    REFERENCES `petadoptiondb`.`employee` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
